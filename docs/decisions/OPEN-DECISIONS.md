...
| 2026-08-21 | 设计 §12 ③ | ref_price 来源 | — | — | — | — | RESOLVED（v0.2 去计费化：删除 ref_price/余额槽位，改为固定并发上限 `MAX_SLOTS`） |
| 2026-08-21 | 设计 §12 ④ | channel_id 回填来源 | — | — | — | — | RESOLVED（v0.2 / ADR-006：channel_id 改为**本服务写入的独立渠道号** `CHANNEL_ID`，不再从响应头回填） |
